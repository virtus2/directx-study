...
bool LightMapShader::Initialize(ID3D11Device* device, HWND hWnd)
{
	...
	wcscpy_s(vsFilename, 128, L"LightMap.vs");

	wchar_t psFilename[128];
	wcscpy_s(psFilename, 128, L"LightMap.ps");
...
bool LightMapShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix,
...
bool LightMapShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, 
	ID3D11ShaderResourceView** textureArray)
{
	HRESULT result;
