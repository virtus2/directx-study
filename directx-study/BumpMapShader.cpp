...
BumpMapShader::BumpMapShader(const BumpMapShader&)
{
}
...
bool BumpMapShader::Initialize(ID3D11Device* device, HWND hWnd)
{
	...
	wcscpy_s(vsFilename, 128, L"BumpMap.vs");

	wchar_t psFilename[128];
	wcscpy_s(psFilename, 128, L"BumpMap.ps");
...
bool BumpMapShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix,
...
bool BumpMapShader::InitializeShader(ID3D11Device* device, HWND hWnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "BumpMapVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
	...
	result = D3DCompileFromFile(psFilename, NULL, NULL, "BumpMapPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
...
bool BumpMapShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, 
	ID3D11ShaderResourceView** textureArray, XMFLOAT3 lightDirection, XMFLOAT4 diffuseColor)
{
	HRESULT result;
