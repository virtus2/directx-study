...
bool FontShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	wcscpy_s(vsFilename, 128, L"font.vs");
	wcscpy_s(psFilename, 128, L"font.ps");
...
bool FontShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, 
